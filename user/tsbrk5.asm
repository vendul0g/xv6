...
void test1()
{
  ...
  *(a+1) = 1;  // Debe fallar
  ...
  26:	68 42 04 00 00       	push   $0x442
  2b:	6a 02                	push   $0x2
  2d:	e8 f1 01 00 00       	call   223 <printf>
}
...
void test2()
{
  ...
  40:	68 ac 03 00 00       	push   $0x3ac
  45:	6a 01                	push   $0x1
  47:	e8 d7 01 00 00       	call   223 <printf>
  char* a = (char*)((int)&i + 4095);
  printf (1, "0x%x\n", a);
  4c:	83 c4 0c             	add    $0xc,%esp
  4f:	68 27 16 00 00       	push   $0x1627
  54:	68 5d 04 00 00       	push   $0x45d
  59:	6a 01                	push   $0x1
  5b:	e8 c3 01 00 00       	call   223 <printf>
  *a = 1;//Esta instrucción debe fallar
  60:	c6 05 27 16 00 00 01 	movb   $0x1,0x1627
  printf(1,"Página de guarda accedida\n");
  67:	83 c4 08             	add    $0x8,%esp
  6a:	68 63 04 00 00       	push   $0x463
  6f:	6a 01                	push   $0x1
  71:	e8 ad 01 00 00       	call   223 <printf>
}
...
void test3()
{
  ...
  81:	68 f8 03 00 00       	push   $0x3f8
  86:	6a 01                	push   $0x1
  88:	e8 96 01 00 00       	call   223 <printf>
  ...
  *(a+1) = 1;  // Debe fallar (si lo anterior no ha fallado)
  ...
  97:	68 7f 04 00 00       	push   $0x47f
  9c:	6a 01                	push   $0x1
  9e:	e8 80 01 00 00       	call   223 <printf>
}
...
00000180 <getprio>:
SYSCALL(getprio)
 180:	b8 18 00 00 00       	mov    $0x18,%eax
 185:	cd 40                	int    $0x40
 187:	c3                   	ret    

00000188 <setprio>:
SYSCALL(setprio)
 188:	b8 19 00 00 00       	mov    $0x19,%eax
 18d:	cd 40                	int    $0x40
 18f:	c3                   	ret    
...
putc(int fd, char c)
{
 ...
 19e:	52                   	push   %edx
 19f:	50                   	push   %eax
 1a0:	e8 4b ff ff ff       	call   f0 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 1db:	43                   	inc    %ebx
 1dc:	8a 92 f8 04 00 00    	mov    0x4f8(%edx),%dl
...
printf(int fd, const char *fmt, ...)
{
 ...
 29e:	ff 24 85 a0 04 00 00 	jmp    *0x4a0(,%eax,4)
        printint(fd, *ap, 10, 1);
 ...
 303:	75 13                	jne    318 <printf+0xf5>
          s = "(null)";
 305:	be 96 04 00 00       	mov    $0x496,%esi
